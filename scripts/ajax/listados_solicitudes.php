...
if($estado_convocatoria<=20) $disabled='';
...
if($rol=='admin' or $rol=='sp')
{
  ...
  { 
   ...
   //if($estado_convocatoria==16) print($form_sorteo_parcial); //mostramos formulario para hacer el sorteo, ya se han hecjo las asignaciones
   if($estado_convocatoria>=10) print($form_nuevasolicitud);
...
else//accedemos como centro
{
	...
	$solicitudes=$list->getSolicitudes($id_centro,$estado_convocatoria,'normal','normal',$solicitud,$log_listados_solicitudes,0,$rol,$provincia); 
