...
foreach($res as $aldata)
{
   ...
   if($sri==1)
   {
      $rri=$utils->comprobarBaremo('imv',$dni,$dni1,$dni2);
   ...
   if($sda==1)
   {
      $rda=$utils->comprobarBaremo('discapacidad_alumno',$dni,$dni1,$dni2);
   ...
   if($sdh==1)
   {
      $rdh=$utils->comprobarBaremo('discapacidad_hermanos',$dnidisc1,$dnidisc2,$dnidisc3);
   ...
   if($sfn==1)
   {
      $rfn=$utils->comprobarBaremo('familia_numerosa',$dni,$dni1,$dni2);
   ...
   if($sfm==1)
   {
      $rfm=$utils->comprobarBaremo('familia_monoparental',$dni,$dni1,$dni2);
