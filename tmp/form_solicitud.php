...
<div class="row">
   <div class="col-md-5">
      <div class="md-form mb-0">
         ...
         <span class="ttip" data-toggle="tooltip" title="Texto proximidad domicilio"><i class="fas fa-info"></i></span>
         <br><span class="ttip" data-toggle="tooltip" title="Texto proximidad domicilio"><i>Texto explicativo domicilio</i></span>
    ...
    <div class="col-md-3">
      <div class="md-form mb-0">
         <input type="checkbox" id="baremo_renta_inferior" name="baremo_renta_inferior" value="1" data-baremo="1" >
         <label> Renta inferior IMV (Ingreso Mínimo vital)</label>
         <br><span class="ttip" data-toggle="tooltip" title="Texto proximidad domicilio"><i>Texto explicativo renta inferior</i></span>
      </div>
      ...
      <a id="borrarrenta_inferior" class="enlacefbaremo enlaceborrarfichero" style="display:none" class="enlacefbaremo" target="_blank">Retirar fichero</a>
...
<!--INICIO FILA DATOS NUEVOS BAREMO-->
	      <div class="row">
               ...
               <div class="md-form mb-0">
                  ...
                  <br><span class="ttip" data-toggle="tooltip" title="Texto proximidad domicilio"><i>Texto explicativo de acogimiento</i></span>
               </div>
               ...
               <div class="md-form mb-0">
                  ...
                  <br><span class="ttip" data-toggle="tooltip" title="Texto proximidad domicilio"><i>Texto explicativo de género</i></span>
               </div>
            ...
            <div class="col-md-3">
               <div class="md-form mb-0">
                  ...
                  <br><span class="ttip" data-toggle="tooltip" title="Texto proximidad domicilio"><i>Texto explicativo de terrorismo</i></span>
               </div>
            ...
            <div class="col-md-3">
               <div class="md-form mb-0">
                  ...
                  <br><span class="ttip" data-toggle="tooltip" title="Texto proximidad domicilio"><i>Texto explicativo de parto</i></span>
               </div>
...
<!--INICIO FILA DATOS NUEVOS PARA FICHEROS JUSTIFICATIVOS-->
	      <div class="row">
               ...
               <a id="borraracogimiento" class="enlacefbaremo enlaceborrarfichero" style="display:none" class="enlacefbaremo" target="_blank">Retirar fichero</a>
            </div>
        	   <div class="col-md-3">
               ...
               <a id="borrargenero" class="enlacefbaremo enlaceborrarfichero" style="display:none" class="enlacefbaremo" target="_blank">Retirar fichero</a>
            </div>
        	   <div class="col-md-3">
               ...
               <a id="borrarterrorismo" class="enlacefbaremo enlaceborrarfichero" style="display:none" class="enlacefbaremo" target="_blank">Retirar fichero</a>
            </div>
        	   <div class="col-md-3">
...
<!--INICIO FILA DATOS-->
   <div class="row">
      <div class="col-md-4">
         ...
         <br><span class="ttip" data-toggle="tooltip" title="Texto proximidad domicilio"><i>Texto explicativo de discapacidad</i></span>
         <div id="cajabaremo_discapacidad" class="cajabaremo"> 
            ...
            <div class="radio">
               <label><input type="checkbox" name="baremo_discapacidad_hermanos" value="1" data-baremo="1">De padres/hermanos</label>
            </div>
          ...
          <div class="col-md-4">
            ...
            <div id="cajabaremo_numerosa" class="cajabaremo"> 
               ...
               <div class="radio">
                  <label><input type="radio" name="baremo_tipo_familia_numerosa" value="0" data-baremo="2">Especial</label>
               </div>
