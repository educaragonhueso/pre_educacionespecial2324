...
$advice = new StdClass();
$advice->advice = new StdClass();
$advice->advice->anagrama ="lhueso@aragon.es";
$advice->advice->application ="GIR";
$advice->advice->date ="05/02/2021";
$advice->advice->description ="Aviso Pruebas Admision";
$advice->advice->entityId ="10050";
$advice->advice->mailSubject ="Pruebas admisión";
$advice->advice->subject ="Pruebas admisión subject";
$advice->advice->type ="pruebasdesp";


$paramcreateadvice = new ParamCreateAdvice();
$paramcreateadvice->setUser('00000000T');
$paramcreateadvice->setIdApplication('GIR');
$paramcreateadvice->setOAdvice($advice);
...
try {
        $result = $client->createAdvice($paramcreateadvice);
