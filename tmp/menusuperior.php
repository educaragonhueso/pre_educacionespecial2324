...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
   ...
   <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav navbar-expand-md ">
        <li class="nav-item ">
         <a class='nav-link' href='<?php echo $_SESSION['url_base'].'/'.$directoriobase.'/hitos.php';?>' target='_blank'>PRUEBASHITOS</a>
        </li>
        <li class="nav-item">
         <a class='nav-link'  href='<?php echo $_SESSION['url_base'].'/'.$directoriobase.'/faq.php';?>' target='_blank'>PRUEBASFAQ</a>
        </li>
      </ul>
  </div>  
</nav>
...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
   <ul class="navbar-nav navbar-expand-md ">
     <li class="nav-item  msuperior">
      <a class='nav-link' style='color:white!important;float:left!important;padding-top:9px'  href='<?php echo $_SESSION['url_base'].'/'.$directoriobase.'/hitos.php';?>' target='_blank'>HITOS</a>
     </li>
     <li class="nav-item  msuperior">
