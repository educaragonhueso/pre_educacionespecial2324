...
class SolicitudController{
    ...
    public function __construct($rol='centro',$conexion,$formulario) 
		{
...
or $skey=='oponenautorizar'or $skey=='cumplen')
    ...
    public function showFormSolicitud($id=0,$id_centro=0,$rol='alumno',$collapsed=1,$imprimir=0,$estado_convocatoria=0,$conexion,$log)
		{
			...
			else
			{
				...
				$log->warning("DATOS SOLICITUD A EDITAR");
