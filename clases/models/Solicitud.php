	...
	public function getSolicitudesFase2Finales($subtipo_listado,$rol,$id_centro,$estado_convocatoria,$log,$id_alumno) 
   {
      ...
      $resultSet=array();
		if($subtipo_listado=='lfinal_sol_ebo')
		   $sql="SELECT a.tel_dfamiliar1 as telefono,'centrosdisponibles' as centrosdisponibles,a.id_alumno,a.tipoestudios,a.id_centro_final, a.apellido1,a.apellido2,a.nombre,c.nombre_centro as centro_definitivo,cc.nombre_centro as centro_solicitado FROM alumnos a,centros c,centros cc WHERE c.id_centro=a.id_centro_final AND cc.id_centro=a.id_centro_destino AND a.tipoestudios='ebo' $where order by a.id_centro_final desc, a.tipoestudios asc,a.nordensorteo asc,a.transporte asc";
   	elseif($subtipo_listado=='lfinal_sol_tva')
		   $sql="SELECT 'centrosdisponibles' as centrosdisponibles,a.id_alumno,a.tipoestudios,a.id_centro_final, a.apellido1,a.apellido2,a.nombre,c.nombre_centro as centro_definitivo FROM alumnos a,centros c WHERE c.id_centro=a.id_centro_final AND a.tipoestudios='tva' $where order by a.id_centro_final desc, a.tipoestudios asc,a.nordensorteo asc,a.transporte asc";
