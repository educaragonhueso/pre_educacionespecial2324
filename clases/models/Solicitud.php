	   ...
	   elseif($rol=='admin') //para administradorn
      {
         ...
         else
         {
            if($id_centro>0)
               ...
               $sql="SELECT a.conjunta, a.id_alumno,a.nombre,a.apellido1,a.apellido2,a.fase_solicitud,a.estado_solicitud,a.transporte,a.nordensorteo,a.tipoestudios,nasignado, IFNULL(b.puntos_validados,0) as puntos_validados,a.token,b.*,rec.tipo FROM $tabla_alumnos a left join baremo b on b.id_alumno=a.id_alumno left join reclamaciones rec on rec.id_alumno=a.id_alumno $noborradora $filtrorec  order by a.id_centro_destino, a.tipoestudios, a.apellido1,a.nombre,a.transporte asc,b.puntos_validados desc,b.hermanos_centro desc,b.proximidad_domicilio,b.renta_inferior,b.discapacidad_alumno,b.discapacidad_hermanos,b.tipo_familia_numerosa,b.tipo_familia_monoparental,a.nordensorteo asc,a.nasignado desc";
         }
      }
	   elseif($rol=='sp') //para servicio provincial
      {
         ...
         {
           $sql="SELECT a.conjunta, a.id_alumno,a.nombre,a.apellido1,a.apellido2,a.fase_solicitud,a.estado_solicitud,a.transporte,a.nordensorteo,a.tipoestudios,nasignado, IFNULL(b.puntos_validados,0) as puntos_validados,a.token,b.* FROM $tabla_alumnos a join centros c on c.id_centro=a.id_centro_destino left join baremo b on b.id_alumno=a.id_alumno $noborradora WHERE provincia='$provincia'  order by a.id_centro_destino, a.tipoestudios, a.apellido1,a.nombre,a.transporte asc,b.puntos_validados desc,b.hermanos_centro desc,b.proximidad_domicilio,b.renta_inferior,b.discapacidad_alumno,b.discapacidad_hermanos,b.tipo_familia_numerosa,b.tipo_familia_monoparental,a.nordensorteo asc,a.nasignado desc";
         }
      }
