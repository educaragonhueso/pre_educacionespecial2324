   ...
   //creamos la consulta para la tabla de hermanos, para admision
	foreach($hermanos_admision as $key=>$hermano)
	{
      ...
      if($existe_hermano==1)
      {
         ...
         $sql=$query_hermanos_admision."apellido2='".$hermano['apellido2']."',apellido1='".$hermano['apellido1']."',nombre='".$hermano['nombre']."',fnac='".$hermano['fnac']."',tipoestudios='".$hermano['tipoestudios']."'";	
         ...
         $log->warning("HERMANO ADMISON NO EXISTE");
   }
    ...
    public function getHermanos($tipo,$id,$log) 
	 {
      $resultSet=array();
		...
		else if($tipo=='admision')
		{
         ...
         $squery="SELECT nombre,apellido1,apellido2,fnac,tipoestudios,token FROM alumnos where id_alumno IN(SELECT id_hermano FROM alumnos_hermanos_admision ah WHERE ah.id_alumno=$id)";
         ...
         $r1=array('hermanos_admision_nombre1'=>'','hermanos_admision_apellido11'=>'','hermanos_admision_apellido21'=>'','hermanos_admision_fnac1'=>'','hermanos_admision_tipoestudios1'=>'','hermanos_admision_tipoestudios1'=>'');
         $r2=array('hermanos_admision_nombre2'=>'','hermanos_admision_apellido12'=>'','hermanos_admision_apellido22'=>'','hermanos_admision_fnac2'=>'','hermanos_admision_tipoestudios2'=>'','hermanos_admision_tipoestudios2'=>'');
         $r3=array('hermanos_admision_nombre3'=>'','hermanos_admision_apellido13'=>'','hermanos_admision_apellido23'=>'','hermanos_admision_fnac3'=>'','hermanos_admision_tipoestudios3'=>'','hermanos_admision_tipoestudios3'=>'');
