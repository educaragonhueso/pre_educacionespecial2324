...
$rol=$_SESSION['rol'];
?>
<!------ Hitos del proceso de admisión ---------->

<div class="container ">
   <h1>Hitos proceso admisión Educación Especial</h1> 
   <br>
 <div class="panel-group" id="faqAccordion">
  <?php include("hitos_content.php");?>
 </div>
<?php if($rol=='admin')
 {
