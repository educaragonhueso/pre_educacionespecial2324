   ...
   public function getEstadoAlumno($token)
	{
         ...
         if($this->estado_convocatoria>=ESTADO_RECLAMACIONES_PROVISIONAL)
            $msg.= "<div style='padding:10px;margin-left:40%'> PUEDES RECLAMAR DESDE ESTE ENLACE <a href='https://".URL_BASE."/".EDICION."/reclamaciones_provisional.php?token=$token' style='color:darkblue;background-color:black;padding:6px'> DESDE ESTE ENLACE</a></div>";
